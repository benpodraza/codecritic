...
fake_tp_module = types.SimpleNamespace(ToolProviderPreprocessor=DummyToolProvider)
...
class RegistryFactoryTests(unittest.TestCase):
    def setUp(self):
        ...
        sys.modules['app.systems.preprocessing.utils.tool_provider_preprocessor'] = fake_tp_module
        sys.modules['app.systems.preprocessing.utils.context_provider_preprocessor'] = types.SimpleNamespace(ContextProviderPreprocessor=lambda _: None)
