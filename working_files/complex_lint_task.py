...
# - Split the import statement into multiple lines for better readability and to comply with PEP8.
...
# - Ensured consistent return types for functions, such as returning `0.0` instead of `0` in `calculate_area`.
# - Made sure all functions have a return type annotation, including `-> None` for functions that do not return a value.
# - These changes improve code readability, maintainability, and type safety without altering the original logic.
# -----------------------------------------------
